...
\paragraph{PokeWorld.} This synthetic contact benchmark varies mass, contact stiffness, and drag while keeping object appearance fixed \citep{latent-wm-identifiability}. Its differentiable solver matches the generator, providing true-parameter and solver-adequacy certificates. The reported runs use 2,048 episodes, a tiny CNN diagnostic encoder, and three seeds.
