...
% ---------------------------------------------------------------------
% NeurIPS style. "preprint" = non-anonymized, arXiv-style; no workshop
% title or double-blind line numbers needed at this draft stage. Swap
% to [dblblindworkshop]/[sglblindworkshop] (with \workshoptitle{...})
% or [main] when a venue is picked -- see neurips_2026.tex for options.
% ---------------------------------------------------------------------
\usepackage[preprint]{neurips_2026}

% ---------------------------------------------------------------------
% Packages. geometry is NOT loaded here -- neurips_2026.sty sets the
% page geometry itself and tweaking it is grounds for desk rejection.
% ---------------------------------------------------------------------
...
\title{Filling the Hierarchy from the Top:\\
